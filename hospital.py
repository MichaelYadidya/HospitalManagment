...
class Hospital:
    ...
    def Input(self):
        ...
        self.sex = input('Enter the patient\'s Sex: ')
        self.height = input('Enter Patient\'s Height: ')
        self.weight = input('Enter the Patient\'s Weight: ')
        self.bgroup = input('Enter the Blood Group: ')
        ...
        self.dname = input('Enter the disease name: ')
        self.med  = input('Enter the Prescribed Medicine: ')
        self.bill = input('Enter the bill amount: Rs.')
        self.paymethod = input('Enter Payment Method: ')
        ...
        while True:
            ...
            if ob.sno == b:
                ...
                if n==1:
                    ...
                    a=input('Enter Patient\'s age:')
                    ob.age=a
                    pickle.dump(ob,fout)
                elif n==3:
                    a=input('Enter Patient\'s Sex: ')
                    ob.sex=a
                    pickle.dump(ob.fout)
                elif n==4:
